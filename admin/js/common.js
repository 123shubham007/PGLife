window.addEventListener("load", function() {
    ...
    var hostel_form = document.getElementById("hostel-form");
    hostel_form.addEventListener("submit", function(event) {
        var XHR = new XMLHttpRequest();
        ...
        // Set up request
        XHR.open("POST", "api/hostel_submit.php");
...
var hostel_success = function(event) {
    document.getElementById("loading").style.display = 'none';
